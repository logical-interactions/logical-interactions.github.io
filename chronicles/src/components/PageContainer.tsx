...
export default class PageContainer extends React.Component<undefined, PageContainerState> {
  ...
  render() {
    ...
    let chronicles = (<>
      ...
      <p>For multiple results to be meaninful, we added some annotation to the charts, which brings the following design you see, go ahead and play with the visualization.
      </p>
      <MergedContainer
        ref={c => this.m1 = c}
        bufferSize={100}
