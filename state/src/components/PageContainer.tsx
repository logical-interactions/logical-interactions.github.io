...
export default class PageContainer extends React.Component<undefined, undefined> {
  render() {
    return (<>
      ...
      <p>
        In the bad old days, the UI state is simple---it barely has any. Everything you would possibly need is in the HTML, and some functions. It's <i>stateless</i>. Now, we have dozens of libraries just for managing frontend state, such as <a href="https://github.com/reactjs/redux">redux</a>, <a href="https://github.com/mobxjs/mobx">mobx</a>, and <a href="https://github.com/cyclejs/cyclejs">cycle.js</a>.
      </p>
      <p>
      ...
      <p>Database is all about state management. Events, logs, data, same deal. Databases are important to use because it helps organizations persist structured information, upon which queries may transform basi information into knowledge.</p>
      <p></p>
      <p className="quote">
